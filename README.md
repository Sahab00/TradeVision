# TradeVision
A Python bot for MEXC Futures that fetches live prices, calculates EMA, RSI, Bollinger Bands, and provides automated trading signals with suggested entry, stop-loss, and take-profit levels.

## Demoo for Using the TradeVision Bot
<video src="assets/assets/demo_video.mp4" width="600" controls></video>
...
2. Auto-trade execution (with API keys)
3. Web dashboard enhancements
4. More advanced indicators (MACD, SuperTrend, Ichimoku, etc.)

## Contributing

Pull requests are welcome!
If you’d like to improve indicators, UI, or add new features, feel free to:
1. Fork the repository
2. Create a new branch
3. Submit a pull request

## Contact
If you have suggestions, issues, or want to collaborate:
Developer: Sahab Mushtaq
GitHub: Sahab00
